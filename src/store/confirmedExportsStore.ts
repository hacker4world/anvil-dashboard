...
interface ConfirmedExportState {
  // Data
 ...
 * the currently applied advanced filters. Always includes confirmed: true
...
export const useConfirmedExportStore = create<ConfirmedExportState>()(
  (set, get) => ({
    ...initialState,
    ...
    fetchExports: async (reset = false) => {
      ...
      try {
        ...
        const message = extractErrorMessage(
          err,
          "Erreur lors du chargement des sorties confirmées",
        );
